!(function() {
    ...
    return (
      (t.on = function(t, u) {
        ...
        return arguments.length < 2
          ? a && a.on
          : (a && ((a.on = null), (e = e.slice(0, (i = e.indexOf(a))).concat(e.slice(i + 1))), r.remove(t)), u && e.push(r.set(t, { on: u })), n);
      }),
      t
    );
  }
  ...
  function gn(n, t, e) {
    ...
    return (
      ...
      (r = vn(r) * Qa),
      (i = vn(i) * no),
      new yn(mn(3.2404542 * u - 1.5371385 * r - 0.4985314 * i), mn(-0.969266 * u + 1.8760108 * r + 0.041556 * i), mn(0.0556434 * u - 0.2040259 * r + 1.0572252 * i))
    );
  }
  function pn(n, t, e) {
  ...
  function _n(n, t, e) {
    ...
    return (i = ro.get(n))
      ...
      : (null == n ||
          ...
          (4 === n.length
            ? ((a = (3840 & i) >> 4), (a = (a >> 4) | a), (o = 240 & i), (o = (o >> 4) | o), (l = 15 & i), (l = (l << 4) | l))
  ...
  function wn(n, t, e) {
    ...
    return (
      o
        ? ((u = 0.5 > l ? o / (a + i) : o / (2 - a - i)), (r = n == a ? (t - e) / o + (e > t ? 6 : 0) : t == a ? (e - n) / o + 2 : (n - t) / o + 4), (r *= 60))
        : ((r = NaN), (u = l > 0 && 1 > l ? 0 : r)),
      new ln(r, u, l)
    );
  }
  ...
  function Cn(n, t, e, r) {
    ...
    return (
      ...
      (i.send = function(e, r, u) {
        if (
          (2 === arguments.length && 'function' == typeof r && ((u = r), (r = null)), l.open(e, n, !0), null == t || 'accept' in o || (o.accept = t + ',*/*'), l.setRequestHeader)
        )
          ...
          return (
            'j' in r
              ...
              ? ('w' in r || (r.w = 'W' in r ? 1 : 0),
                ...
                a.setFullYear(r.y, 0, 'W' in r ? ((r.w + 6) % 7) + 7 * r.W - ((a.getDay() + 5) % 7) : r.w + 7 * r.U - ((a.getDay() + 6) % 7)))
      ...
      var g,
        ...
        y = {
          ...
          polygonEnd: function() {
            ...
            var n = Ot(m, p);
            g.length ? (b || (i.polygonStart(), (b = !0)), Lt(g, jt, n, e, i)) : n && (b || (i.polygonStart(), (b = !0)), i.lineStart(), e(null, null, 1, i), i.lineEnd()),
              b && (i.polygonEnd(), (b = !1)),
              (g = p = null);
          },
          sphere: function() {
    ...
    return {
      ...
      point: function(i, a) {
        var o = i > 0 ? ja : -ja,
          l = Ma(i - e);
        Ma(l - ja) < Da
          ? (n.point(e, (r = (r + a) / 2 > 0 ? Ha : -Ha)), n.point(u, r), n.lineEnd(), n.lineStart(), n.point(o, r), n.point(i, r), (t = 0))
          : u !== o &&
            l >= ja &&
            (Ma(e - u) < Da && (e -= u * Da), Ma(i - o) < Da && (i -= o * Da), (r = Ft(e, r, i, a)), n.point(u, r), n.lineEnd(), n.lineStart(), n.point(o, r), (t = 0)),
          n.point((e = i), (r = a)),
          (u = o);
      },
      lineEnd: function() {
    ...
    function r(n, t, e) {
      ...
      if (!(0 > M)) {
        ...
        var E = S - w,
          ...
          C = A || Da > E;
        if (
          (!A && k > N && ((_ = k), (k = N), (N = _)), C ? (A ? (k + N > 0) ^ (b[1] < (Ma(b[0] - w) < Da ? k : N)) : k <= b[1] && b[1] <= N) : (E > ja) ^ (w <= b[0] && b[0] <= S))
        ) {
          var z = xt(d, (-m + x) / y);
    ...
    function u(t, e, r, o, l, c, s, f, h, g, p, v, d, m) {
      ...
      if (x > 4 * i && d--) {
        ...
        ((q * q) / x > i || Ma((y * z + M * L) / x - 0.5) > 0.3 || a > o * g + l * p + c * v) &&
          (u(t, e, r, o, l, c, A, C, N, (b /= S), (_ /= S), w, d, m), m.point(A, C), u(A, C, N, b, _, w, s, f, h, g, p, v, d, m));
      }
    }
    var i = 0.5,
      a = Math.cos(30 * Oa),
  ...
  function ve(n, t) {
    ...
    return function(u, i, a, o) {
      var l = a * t;
      null != u ? ((u = de(e, u)), (i = de(e, i)), (a > 0 ? i > u : u > i) && (u += a * Ua)) : ((u = n + a * Ua), (i = n - 0.5 * l));
  ...
  function yr(n, t) {
    ...
    for (n += '', t += ''; (e = fl.exec(n)) && (r = hl.exec(t)); )
      (u = r.index) > i && ((u = t.slice(i, u)), o[a] ? (o[a] += u) : (o[++a] = u)),
        (e = e[0]) === (r = r[0]) ? (o[a] ? (o[a] += r) : (o[++a] = r)) : ((o[++a] = null), l.push({ i: a, x: mr(e, r) })),
        (i = hl.lastIndex);
    return (
  ...
  function Zr(n, t, e, r) {
    n !== t
      ? (n - t > 180 ? (t += 360) : t - n > 180 && (n += 360), r.push({ i: e.push(Ir(e) + 'rotate(', null, ')') - 2, x: mr(n, t) }))
  ...
  function Ui(n) {
    for (var t, e, r, u, i = [], a = ji(n), o = -1, l = n.length - 1; ++o < l; )
      (t = Pi(n[o], n[o + 1])),
        Ma(t) < Da ? (a[o] = a[o + 1] = 0) : ((e = a[o] / t), (r = a[o + 1] / t), (u = e * e + r * r), u > 9 && ((u = (3 * t) / Math.sqrt(u)), (a[o] = u * e), (a[o + 1] = u * r)));
  ...
  (oa.ascending = e),
    ...
    (oa.variance = function(n, t) {
      var e,
        ...
        c = -1,
        s = 0;
      if (1 === arguments.length) for (; ++c < a; ) u((e = r(n[c]))) && ((i = e - o), (o += i / ++s), (l += i * (e - o)));
  ...
  (eo.brighter = function(n) {
    ...
    var t = this.r,
      ...
      u = 30;
    return t || e || r
      ? (t && u > t && (t = u), e && u > e && (e = u), r && u > r && (r = u), new yn(Math.min(255, t / n), Math.min(255, e / n), Math.min(255, r / n)))
      : new yn(u, u, u);
  }),
  ...
  (oa.geo.bounds = (function() {
    ...
    (oa.geo.centroid = function(n) {
      ...
      var t = Ro,
        ...
        r = Po,
        u = t * t + e * e + r * r;
      return Pa > u && ((t = Lo), (e = qo), (r = To), Da > Eo && ((t = Ao), (e = Co), (r = zo)), (u = t * t + e * e + r * r), Pa > u)
        ? [NaN, NaN]
  ...
  (oa.geo.clipExtent = function() {
    var n,
      ...
      a = {
        ...
        extent: function(o) {
          return arguments.length
            ? ((i = Zt((n = +o[0][0]), (t = +o[0][1]), (e = +o[1][0]), (r = +o[1][1]))), u && ((u.valid = !1), (u = null)), a)
            : [
                [n, t],
                [e, r],
              ];
      ...
      return (
        (n.invert = function(n) {
          var t = i.scale(),
            ...
            r = (n[0] - e[0]) / t,
            u = (n[1] - e[1]) / t;
          return (u >= 0.12 && 0.234 > u && r >= -0.425 && -0.214 > r ? a : u >= 0.166 && 0.234 > u && r >= -0.214 && -0.115 > r ? o : i).invert(n);
        }),
        (n.stream = function(n) {
          var t = i.stream(n),
            e = a.stream(n),
    ...
    (oa.geo.graticule = function() {
      ...
      return (
        ...
        (n.majorExtent = function(t) {
          return arguments.length
            ? ((i = +t[0][0]), (u = +t[1][0]), (c = +t[0][1]), (l = +t[1][1]), i > u && ((t = i), (i = u), (u = t)), c > l && ((t = c), (c = l), (l = t)), n.precision(y))
            : [
                [i, c],
                [u, l],
              ];
        ...
        (n.minorExtent = function(t) {
          return arguments.length
            ? ((r = +t[0][0]), (e = +t[1][0]), (o = +t[0][1]), (a = +t[1][1]), r > e && ((t = r), (r = e), (e = t)), o > a && ((t = o), (o = a), (a = t)), n.precision(y))
            : [
                [r, o],
                [e, a],
              ];
    ...
    (er.prototype = {
      insert: function(n, t) {
        ...
        for (t.L = t.R = null, t.U = e, t.C = !0, n = t; e && e.C; )
          (r = e.U),
            e === r.L
              ? ((u = r.R), u && u.C ? ((e.C = u.C = !1), (r.C = !0), (n = r)) : (n === e.R && (ur(this, e), (n = e), (e = n.U)), (e.C = !1), (r.C = !0), ir(this, r)))
              : ((u = r.L), u && u.C ? ((e.C = u.C = !1), (r.C = !0), (n = r)) : (n === e.L && (ir(this, e), (n = e), (e = n.U)), (e.C = !1), (r.C = !0), ur(this, r))),
            (e = n.U);
        this._.C = !1;
      },
      remove: function(n) {
        ...
        if (
          ...
          i && a
            ? ((r = e.C), (e.C = n.C), (e.L = i), (i.U = e), e !== a ? ((u = e.U), (e.U = n.U), (n = e.R), (u.L = n), (e.R = a), (a.U = e)) : ((e.U = u), (u = e), (n = e.R)))
            : ((r = n.C), (n = e)),
          n && (n.U = u),
          !r)
        ) {
          ...
          for (n(h, (c.dx * c.dy) / e.value), s.area = 0; (l = h.length) > 0; )
            s.push((a = h[l - 1])),
              ...
              'squarify' !== g || (o = r(s, v)) <= p
                ? (h.pop(), (p = o))
                : ((s.area -= s.pop().area), u(s, v, c, !1), (v = Math.min(c.dx, c.dy)), (s.length = s.area = 0), (p = 1 / 0));
      ...
      function n() {
        ...
        if (
          ((m = (+l.apply(this, arguments) || 0) / 2) &&
            ((d = i === Ll ? Math.sqrt(n * n + c * c) : +i.apply(this, arguments)), g || (E *= -1), c && (E = tn((d / c) * Math.sin(m))), n && (N = tn((d / n) * Math.sin(m)))),
          c)
        ) {
    ...
    function i() {
      ...
      function d() {
        var n = oa.mouse(b),
          t = !1;
        x && ((n[0] += x[0]), (n[1] += x[1])),
          C || (oa.event.altKey ? (M || (M = [(f[0] + f[1]) / 2, (h[0] + h[1]) / 2]), (L[0] = f[+(n[0] < M[0])]), (L[1] = h[+(n[1] < M[1])])) : (M = null)),
          E && m(n, c, 0) && (r(k), (t = !0)),
          A && m(n, s, 1) && (u(k), (t = !0)),
      ...
      function m(n, t, e) {
        ...
        return (
          ...
          C ? (u = (r += s) + d) : (M && (s = Math.max(l, Math.min(c, 2 * M[e] - r))), r > s ? ((u = r), (r = s)) : (u = s)),
      ...
      var M,
        ...
        q = oa
          ...
          .on('keyup.brush', v);
      if (
        (oa.event.changedTouches ? q.on('touchmove.brush', d).on('touchend.brush', y) : q.on('mousemove.brush', d).on('mouseup.brush', y),
        k
          .interrupt()
          .selectAll('*')
          .interrupt(),
        ...
        return arguments.length
          ? (c &&
            ...
            s &&
              ...
              (u != h[0] || i != h[1]) && (h = [u, i])),
            n)
          : (c && (a ? ((e = a[0]), (r = a[1])) : ((e = f[0]), (r = f[1]), c.invert && ((e = c.invert(e)), (r = c.invert(r))), e > r && ((l = e), (e = r), (r = l)))),
            s && (o ? ((u = o[0]), (i = o[1])) : ((u = h[0]), (i = h[1]), s.invert && ((u = s.invert(u)), (i = s.invert(i))), u > i && ((l = u), (u = i), (i = l)))),
            c && s
              ? [
                  [e, u],
                  [r, i],
