...
export default class Fn {
  ...
  getAvailableElementWidth(e) {
    ...
    return (
      ...
      (t -= parseInt(window.getComputedStyle(e).getPropertyValue('padding-left'))),
      (t -= parseInt(window.getComputedStyle(e).getPropertyValue('padding-right'))),
      (t -= parseInt(window.getComputedStyle(e).getPropertyValue('border-left-width'))),
      (t -= parseInt(window.getComputedStyle(e).getPropertyValue('border-right-width')))
    );
  }
}
